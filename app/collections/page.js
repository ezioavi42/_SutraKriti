            ...
            {loading ? (
              ...
              <div className="text-center py-16 px-4">
                <div className="max-w-md mx-auto">
                  <div className="mb-6">
                    <svg className="w-24 h-24 mx-auto text-[#E9DCC9]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <p className="text-gray-600 mb-6">
                    {selectedCategory !== 'all' && selectedCategory !== 'All' 
                      ? `We're working on bringing beautiful ${selectedCategory.toLowerCase()} to you soon! In the meantime, why not create something unique with a custom order?`
